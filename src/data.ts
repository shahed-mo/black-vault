    ...
    evidence: [
      {
        ...
        description:
          "A partial smudged fingerprint matching a leather butler glove.",
      },
      {
        title: "Torn Silk Fabric",
        description:
          "A piece of black silk snagged on the velvet display cushion inside the vault.",
      },
    ],
    timeline: [
    ...
    evidence: [
      {
        title: "Paint Residue",
        description:
          "Fresh paint residue was discovered on the empty frame surrounding the missing artwork.",
      },
      {
        title: "Disabled Camera",
        description:
          "Camera 4 stopped recording for exactly two minutes during the disappearance.",
      },
    ],
    timeline: [
    ...
    evidence: [
      {
        title: "Broken Clock",
        description:
          "A broken wall clock was found on the floor, stopped at exactly 11:45 PM.",
      },
      {
        title: "Wet Footprints",
        description:
          "Small wet footprints were discovered near the study window despite the window being locked.",
      },
    ],
    timeline: [
    ...
    evidence: [
      {
        title: "Empty Vial",
        description:
          "A tiny glass vial concealed behind a leather book was found near the desk.",
      },
      {
        title: "Altered Will",
        description:
          "A draft of a new will cutting Clara out of the family inheritance.",
      },
    ],
    timeline: [
    ...
    evidence: [
      {
        ...
        description:
          "Room keycard logs show an unauthorized access at 7:42 PM.",
      },
      {
        title: "Dropped Matchbox",
        description:
          "A matchbox originating from a waterfront bar known for espionage contacts.",
      },
    ],
    timeline: [
